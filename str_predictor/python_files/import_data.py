...
def set_config(model_id):
	...
	return training_size, im_width, im_height, im_chan, path2img, path2mask
...
def get_files(model_id):
	...
	training_size, im_width, im_height, im_chan, path2img, path2mask = set_config(model_id)
	#==============================================================================
	...
	for n, id_ in enumerate(training_files_mask):
		...
		x = img_to_array(img)
		x = resize(x, (512, 512, im_chan), mode='constant', preserve_range=True, anti_aliasing=True)
		X_train[n] = x
		y = img_to_array(mask)
		y = resize(y, (512, 512, 1), mode='constant', preserve_range=True, anti_aliasing=True)
		Y_train[n] = y
	print('==============  Done!   ======================')
	...
	return X_train, Y_train, n_test, testing_files_img, testing_files_mask
