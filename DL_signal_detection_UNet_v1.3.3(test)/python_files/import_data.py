...
#dir_mask = 'masks'
dir_mask = 'training/semantic_rgb'
training_size = .7
...
#img_files = next[os.walk(path2img + '/*.png')]
print(img_files)
...
n_test = len(testing_files_img)     ### or training_files_img
...
Y_train = np.zeros((n_train, im_height, im_width, im_chan), dtype=np.uint8)
...
plt.savefig('../output/resized_images_KITTI_preview_x_1.png')
ax51 = plt.figure()
...
#plt.show()
plt.savefig('../output/resized_images_KITTI_preview_y_1.png')
...
ax55.set_title('Sign ')
plt.savefig('../output/previewing_random_training_KITTI_images_masks_1.png')
