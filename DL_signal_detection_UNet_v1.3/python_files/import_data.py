...
#dir_project = 'PCI'
#dir_project = 'test'
dir_project = '20190701_split_and_cropped_1024x1024'
#dir_zmap = 'slab_zmap'
#dir_img = 'slab_img'
dir_img = 'images'
...
#    plt.subplot(1, 3*(1+len(training_files_img_explor_data)), q*3)
 #   plt.title('Image Mask ' + img_name)
    plt.imshow(img_mask)
plt.savefig('../output/images_masks_1024x1024_preview.png')
...
plt.savefig('../output/resized_images_1024x1024_preview_x_1.png')
ax51 = plt.figure()
...
#plt.show()
plt.savefig('../output/resized_images_1024x1024_preview_y_1.png')
...
ax55.set_title('Sign ')
plt.savefig('../output/previewing_random_training_1024x1024_images_masks_1.png')
