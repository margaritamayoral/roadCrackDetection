...
checkpointer = ModelCheckpoint('model-streetscan-signals-1024x1024-4.h5', verbose=1, save_best_only=True)
...
plt.ylabel("log_loss")
plt.legend()
plt.savefig('../output/showing_learning_curve_1024x1024-4.png')
